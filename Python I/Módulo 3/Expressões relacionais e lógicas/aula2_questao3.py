#3) Você está desenvolvendo um sistema de admissão para um clube juvenil de jogos de tabuleiro. Escreva um programa em 
#Python que pergunte ao usuário sua idade, se já jogou pelo menos 3 jogos de tabuleiro (resposta deve ser True ou False) 
#e quantas vezes venceu um jogo. O programa deve imprimir True, permitindo o ingresso do participante no clube, se:
    ...
    #Sua expressão deve imprimir False caso contrário. Aqui está um exemplo de interação com seu código no terminal, com 
    #entradas de dados destacadas em negrito e as impressões de seu código em itálico (apenas para facilitar sua visualização).
#Digite sua idade: 17
