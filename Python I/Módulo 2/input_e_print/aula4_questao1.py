...
#quadrado da região em ponto flutuante. Calcule o valor do terreno e imprima o resultado com a formatação apresentada a 
#seguir.
...
preço_m2 = float(input("Digite o preço por m2: "))

area_m2 = comprimento * largura
preço_total = preço_m2 * area_m2
print(f"O preço total é {preço_total}")